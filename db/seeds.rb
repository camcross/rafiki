...
Option.create(:question_id => 1, :body => "A) 8")
Option.create(:question_id => 1, :body => "B) 10")
Option.create(:question_id => 1, :body => "C) 12")
Option.create(:question_id => 1, :body => "D) 14")
...
Option.create(:question_id => 2, :body => "A) 12 yards")
Option.create(:question_id => 2, :body => "B) 20 yards")
Option.create(:question_id => 2, :body => "C) 18 yards")
Option.create(:question_id => 2, :body => "D) 14 yards")
...
Option.create(:question_id => 3, :body => "A) 2 miles")
Option.create(:question_id => 3, :body => "B) 3 miles")
Option.create(:question_id => 3, :body => "C) 4 miles")
Option.create(:question_id => 3, :body => "D) 5 miles")
...
Option.create(:question_id => 4, :body => "A) √29 inches")
Option.create(:question_id => 4, :body => "B) √32 inches")
Option.create(:question_id => 4, :body => "C) √34 inches")
Option.create(:question_id => 4, :body => "D) 6 inches")
...
Option.create(:question_id => 5, :body => "A) 25 feet")
Option.create(:question_id => 5, :body => "B) 23 feet")
Option.create(:question_id => 5, :body => "C) 27 feet")
Option.create(:question_id => 5, :body => "D) 26 feet")
...
Option.create(:question_id => 6, :body => "A) 36 inches")
Option.create(:question_id => 6, :body => "B) 34 inches")
Option.create(:question_id => 6, :body => "C) 32 inches")
Option.create(:question_id => 6, :body => "D) 30 inches")
...
Option.create(:question_id => 7, :body => "A) 175 meters")
Option.create(:question_id => 7, :body => "B) 183 meters")
Option.create(:question_id => 7, :body => "C) 200 meters")
Option.create(:question_id => 7, :body => "D) 210 meters")
...
Option.create(:question_id => 8, :body => "A) √32 inches")
Option.create(:question_id => 8, :body => "B) √33 inches")
Option.create(:question_id => 8, :body => "C) √30 inches")
Option.create(:question_id => 8, :body => "D) √35 inches")
